...
/* Defines for DMA_Bat */
#define DMA_Bat_BYTES_PER_BURST sizeof(buf_bat[0])
...
void DMA_init(const uint16 skip) {
	...
	CyDmaTdSetConfiguration(DMA_Bat_TD[0], sizeof(buf_bat[0]), DMA_Bat_TD[0], TD_INC_DST_ADR | DMA_Bat__TD_TERMOUT_EN);
